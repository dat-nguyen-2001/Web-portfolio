  ...
  return (
    <div>
      ...
      <div className='px-5 xl:px-28 mt-10'>
        <div className='about text-[.9rem] xl:text-[1.3rem] flex flex-col space-y-4 mb-10'>
        ...
        <div className='skills text-[.9rem] xl:text-[1.3rem] flex flex-col space-y-4 my-10'>
        ...
        <div className='projects text-[.9rem] xl:text-[1.3rem] flex flex-col space-y-4 my-10'>
