      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home h-[35%]'>
          <div className='introduction flex flex-col space-y-3 text-5xl font-[900] h-[120px] ml-[8vw] mt-[30vh] w-auto'>
            ...
            <div className='wobble-hor-bottom w-[10%] h-[70px] rounded-md cursor-pointer border-[1px] border-[blue-500] text-white text-3xl'>
              <p className='mx-auto w-[75%] my-auto py-2'>Resume</p>
            </div>
          </div>
        </div>
      </main>
