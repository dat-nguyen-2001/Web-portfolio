  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex flex-col-reverse w-screen pt-20'>
          <div className='introduction flex flex-col space-y-3 text-[1.3rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[700] md:font-[900] h-[120px] ml-[4vw] md:ml-[6vw] w-auto mt-[10%]'>
            <h1>Hi, my name is Dat</h1>
            <h1 className='flex flex-'>I&apos;m a <span className='pl-2 md:pl-6 text-[#9bb464]'>
              <Typewriter
                options={{
                  autoStart: true,
                  loop: true,
          ...
          <div className='w-[60vw] sm:w-[40vw] h-auto mx-auto'>
