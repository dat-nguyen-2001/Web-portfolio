...
export default function Home() {
  ...
  return (
    <div>
      ...
      <span className='fixed bottom-28 right-16 flex items-center space-x-2 email text-[.9rem]'>
        <EmailIcon />
        <p>
          datnguyenftu210@gmail.com
        </p>
        <div className='h-[1px] w-[10px] text-white'></div>
      </span>
      <main className='overflow-x-hidden h-screen mr-20'>
