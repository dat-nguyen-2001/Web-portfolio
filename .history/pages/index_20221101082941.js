...
export default function Home() {
  ...
  return (
    <div>
      ...
      <span className='email hidden sm:flex fixed bottom-2 md:right-6 lg:right-16 items-center text-[.9rem]'>
      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[60px] md:h-[70px] backdrop-blur-sm	border-b flex space-between items-center px-4 pr-4 md:pr-10 md:px-16 lg:px-24 nav'>
          <div className='flex space-x-2 nav-left'>
            <img src='logo.png' className='w-7 h-6' />
        ...
        <div className='home'>
          <div className='introduction flex flex-col space-y-3 text-[1.3rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[700] md:font-[900] h-[120px] ml-[4vw] md:ml-[8vw] mt-[60%] sm:md-[45%] md:mt-[35%] lg:mt-[15%] w-auto'>
