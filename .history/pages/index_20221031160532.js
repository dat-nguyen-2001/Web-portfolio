  ...
  return (
    <div>
      ...
      <div className='px-28 mt-10'>
        <div className='about text-[1.75]xl flex flex-col space-y-4 mb-10'>
          ...
          <h1 className='text-4xl'><span className='lineNumber'>2 </span> &lt;/<span className='text-red-700'>about</span>&gt;</h1>
        </div>
