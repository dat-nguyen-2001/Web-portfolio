    ...
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex flex-col-reverse md:flex-row w-screen pt-20 sm:pt-12 md:pt-40'>
          <div className='introduction flex flex-col space-y-3 text-[1.3rem] sm:text-[1.7rem]  md:text-[1.85rem] lg:text-[2.3rem] font-[700] md:font-[900] h-[120px] ml-[4vw] md:ml-[6vw] w-auto mt-[10%] sm:mt-[5%] md:mt-[12%] lg:mt-[10%] x'>
