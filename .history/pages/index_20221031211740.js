  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[50px] md:h-[70px] backdrop-blur-sm	border-b flex space-between items-center px-4 md:px-24 nav'>
          <div className='flex space-x-2 nav-left'>
            <img src='logo.png' className='w-6 h-6' />
            <span className='focus-in-expand hidden md:inline'>Dat Nguyen Van</span>
          </div>
          <div className='text-sm space-x-12 nav-right hidden md:flex md:text-base'>
