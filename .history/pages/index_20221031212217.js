  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[50px] md:h-[70px] backdrop-blur-sm	border-b flex space-between items-center px-4 pr-10 md:px-24 nav'>
        ...
        <div className='home h-[35%]'>
          <div className='introduction flex flex-col space-y-3  md:text-[2.7rem] font-[900] h-[120px] ml-[8vw] mt-[30vh] w-auto'>
            <h1>Hi, my name is Dat</h1>
            <h1 className='flex'>I'm a <span className='pl-2 sm:pl-6 text-[#3b49df]'><Typewriter
              options={{
                autoStart: true,
                loop: true,
                delay: 40,
