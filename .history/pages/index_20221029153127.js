...
'/>
        ...
        <div className='projects text-2xl flex flex-col space-y-4 my-10'>
          ...
          <div className='pl-24'>
            <span className='text-red-500'>code </span>
            :
            <span className='text-[#9bb464]'> <a href='https://github.com/dat-nguyen-2001/NEXFLIT' target="_blank" rel="noopener noreferrer">https://github.com/dat-nguyen-2001/NEXTFLIT</a></span>,
          </div>
          <div className='pl-24'>
            <span className='text-red-500'>site </span>
            :
