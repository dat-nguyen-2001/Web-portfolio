...
export default function Home() {
  ...
  return (
    <div>
      ...
      <span className='email hidden md:flex fixed bottom-2 right-16 items-center text-[.9rem]'>
      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[60px] md:h-[70px] backdrop-blur-sm	border-b flex space-between items-center px-4 pr-10 md:px-24 nav'>
        ...
        <div className='home h-[35%]'>
          <div className='introduction flex flex-col space-y-3 sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[900] h-[120px] ml-[8vw] md:mt-[30vh] w-auto'>
