    ...
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex'>
          <div className='basis-6 introduction flex flex-col space-y-3 text-[1.3rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[700] md:font-[900] h-[120px] ml-[4vw] md:ml-[8vw] mt-[50%] sm:mt-[40%] md:mt-[25%] lg:mt-[15%] w-auto'>
