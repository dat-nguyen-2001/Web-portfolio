    ...
    <div>
      ...
      <div className='px-28 mt-10'>
        <div className='about text-2xl flex flex-col space-y-4 mb-10'>
          <h1 className='text-4xl'><span className='lineNumber'>1 </span>&lt;<span className='text-red-700'>about</span>&gt;</h1>
          ...
          <div className='pl-8'>
          <span className='lineNumber'>2 </span><span className='text-red-500'>name </span>
            :
            <span className='lineNumber'>2 </span><span className='text-[#9d68b2]'> &#123;</span>
          ...
          <h1 className='text-4xl'>&lt;/<span className='text-red-700'>about</span>&gt;</h1>
        </div>

        <hr></hr>

        <div className='skills text-2xl flex flex-col space-y-4 my-10'>
          <h1 className='text-4xl'>&lt;<span className='text-red-700'>skills</span>&gt;</h1>
          <div><span className='text-[#f9db9b]'>Console</span>.<span className='text-[#1cbae8]'>log</span><span className='text-[#bd7b4c]'>( </span><span className='text-[#f9db9b]'>Dat</span>.<span className='text-red-500'>skills</span><span className='text-[#bd7b4c]'> )</span>;</div>
...
'/>
        ...
        <div className='projects text-2xl flex flex-col space-y-4 my-10'>
          ...
          <div><span className='text-[#f9db9b]'>Console</span>.<span className='text-[#1cbae8]'>log</span><span className='text-[#bd7b4c]'>( </span><span className='text-[#f9db9b]'>Dat</span>.<span className='text-red-500'>projects</span><span className='text-[#bd7b4c]'> )</span>;</div>
