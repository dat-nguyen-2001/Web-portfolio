    ...
    <div>
      ...
      <div className='px-28 mt-10'>
        ...
        <div className='skills text-2xl flex flex-col space-y-4 my-10'>
          ...
          <div><span className='text-[#f9db9b]'>Console</span>.<span className='text-[#1cbae8]'>log</span><span className='text-[#bd7b4c]'>(</span><span className='text-[#f9db9b]'>Dat</span>.<span className='text-red-500'>skills</span><span>)</span>;</div>
