        ...
        <div className='projects text-[1.3rem] flex flex-col space-y-4 my-10'>
          ...
          <div className='flex'>
            ...
            <div className='pl-24'>
              <span className='text-red-500'>code </span>
              :
              <span className='text-[#3b49df]'> <a href='https://github.com/dat-nguyen-2001/Dev.to' target="_blank" rel="noopener noreferrer"><u></u>https://github.com/dat-nguyen-2001/Dev.to</a></span>,
            </div>
          </div>
          <div className='flex'>
