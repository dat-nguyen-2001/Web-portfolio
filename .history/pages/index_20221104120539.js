  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex flex-col-reverse md:flex-row md:space-between w-screen pt-20 sm:pt-12 md:pt-40'>
          <div className='introduction flex flex-col space-y-3 text-[1.3rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[700] md:font-[900] h-[120px] ml-[4vw] md:ml-[6vw] w-auto mt-[10%] sm:mt-[5%]'>
          ...
          <div className='profile w-[60vw] max-w-[250px] sm:w-[40vw] sm:max-w-[350px] md:max-w-[300px] h-auto md:pr-2'>
