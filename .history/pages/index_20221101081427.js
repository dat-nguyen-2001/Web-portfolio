  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home'>
          <div className='introduction flex flex-col space-y-3 text-[1.4rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[700] md:font-[900] h-[120px] ml-[8vw] mt-[60%] md:mt-[15%] w-auto'>
