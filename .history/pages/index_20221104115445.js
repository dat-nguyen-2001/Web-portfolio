    ...
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex flex-col-reverse w-screen pt-20'>
          <div className='introduction flex-wrap flex flex-col space-y-3 text-[1.3rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[700] md:font-[900] h-[120px] ml-[4vw] md:ml-[6vw] w-auto mt-[10%]'>
