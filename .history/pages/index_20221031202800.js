  ...
  return (
    <div>
      ...
      <span className='email fixed bottom-2 right-16 flex items-center text-[.9rem]'>
        <p className='pb-10 tracking-wider'>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home h-[35%]'>
          <div className='introduction flex flex-col space-y-3 text-[2.7rem] font-[900] h-[120px] ml-[8vw] mt-[30vh] w-auto'>
            ...
            <div className='wobble-hor-bottom w-[10%] h-[70px] rounded-md cursor-pointer border-[1px] border-[blue-500] text-white text-2xl'>
        ...
        <div className='projects text-[1.3rem] flex flex-col space-y-4 my-10'>
          ...
          <div className='flex'>
            ...
            <div className='pl-24'>
              ...
              :
              <span className='text-[#3b49df]'> <a href='https://github.com/dat-nguyen-2001/Mujirushi' target="_blank" rel="noopener noreferrer">https://github.com/dat-nguyen-2001/Mujirushi</a></span>,
            </div>
          </div>
          <div className='flex'>
            ...
            <div className='pl-24'>
              ...
              :
              <span className='text-[#3b49df]'> <a href='https://mujirushi.netlify.app/' target="_blank" rel="noopener noreferrer"><u></u>mujirushi.netlify.app</a></span>
            </div>
          </div>
          <div className='flex'>
