    ...
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home h-[100vh]'>
          <div className='introduction flex flex-col space-y-3 text-[1.4rem] sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[900] h-[120px] ml-[8vw] mt-[35vh] md:mt-[30%] w-auto'>
