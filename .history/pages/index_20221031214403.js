  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home h-[35%]'>
          <div className='introduction flex flex-col space-y-3 sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[900] h-[120px] ml-[8vw] mt-[20vh] md:mt-[30vh] w-auto'>
            ...
            <h1 className='flex'>I'm a <span className='pl-2 md:pl-6 text-[#3b49df]'><Typewriter
              options={{
                autoStart: true,
                loop: true,
                delay: 40,
      ...
      <div className='px-5 xl:px-28 mt-10'>
        <div className='about xl:text-[1.3rem] flex flex-col space-y-4 mb-10'>
          <h1  className='text-xl xl:text-3xl'><span className='lineNumber'>1 </span>&lt;<span className='text-red-700'>about</span>&gt;</h1>
          ...
          <h1 className='text-xl xl:text-3xl'><span className='lineNumber'>21 </span> &lt;/<span className='text-red-700'>about</span>&gt;</h1>
        </div>

        <hr id='skills' className='mx-12'></hr>

        <div className='skills xl:text-[1.3rem] flex flex-col space-y-4 my-10'>
          <h1 className='text-xl xl:text-3xl'><span className='lineNumber'>22 </span>&lt;<span className='text-red-700'>skills</span>&gt;</h1>
          ...
          <h1 className='text-xl xl:text-3xl'><span className='lineNumber'>49 </span>&lt;/<span className='text-red-700'>skills</span>&gt;</h1>
        </div>

        <hr id='projects' className='mx-12'></hr>

        <div className='projects xl:text-[1.3rem] flex flex-col space-y-4 my-10'>
          <h1 className='text-xl xl:text-3xl'><span className='lineNumber'>50 </span>&lt;<span className='text-red-700'>projects</span>&gt;</h1>
          ...
          <div className='min-w-[50vw] h-auto pl-32 pr-20'>
            <img className='rounded-sm min-w-[100px] min-h-[70px]' src='https://user-images.githubusercontent.com/94024020/197679626-24a4f4f2-cb92-4e74-8144-bfe9feeca1dc.png' />,
          </div>
          <div className='flex'>
          ...
          <h1 className='text-xl xl:text-3xl'><span className='lineNumber'>87 </span>&lt;/<span className='text-red-700'>projects</span>&gt;</h1>
        </div>
