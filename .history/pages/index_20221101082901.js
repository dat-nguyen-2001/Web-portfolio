  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[60px] md:h-[70px] backdrop-blur-sm	border-b flex space-between items-center px-4 md:pr-10 md:px-16 lg:px-24 nav'>
