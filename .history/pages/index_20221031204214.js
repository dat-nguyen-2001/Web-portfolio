      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[70px] backdrop-blur-sm	border-b flex space-between items-center px-24 nav'>
          ...
          <div className='flex space-x-12 nav-right'>
            <p onClick={scrollToHome} className="curosr">1. Home</p>
            <p onClick={scrollToAbout}>2. About</p>
            <p onClick={scrollToSkills}>3. Skills</p>
            <p onClick={scrollToProjects}>4. Projects</p>
          </div>
        </div>
