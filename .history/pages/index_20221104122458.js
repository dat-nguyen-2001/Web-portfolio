    ...
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex flex-col-reverse md:flex-row w-screen pt-20 sm:pt-12 md:pt-40'>
          ...
          <div className='animate__animated animate__fadeInDown profile w-[60vw] max-w-[250px] sm:w-[35vw] sm:max-w-[350px] md:w-[30vw] md:max-w-[400px] h-auto md:mr-10 lg:mr-20 xl:mr-40'>
