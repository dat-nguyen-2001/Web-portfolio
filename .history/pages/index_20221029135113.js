...
'/>
        ...
        <div className='projects text-2xl flex flex-col space-y-4 my-10'>
          ...
          <div className='pl-24'>
            description: "A social web app like Dev.to. Here you can create articles, like or comment on articles, or save articles for later read. Firstly you need to create an account / login then you could ",
          </div>
          <div className='pl-24'>
            completedIn: "1.5 months",
          </div>
