  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='h-[30%]'>
          <div className='flex flex-col space-y-3 text-5xl font-[900] h-[120px] ml-[8vw] mt-[30vh] w-auto'>
            ...
            <div className='flex space-x-10 pt-5'>
              <a className='hover:w-15 hover:h-15' href='https://www.linkedin.com/in/datnguyen210/' target="_blank" rel="noopener noreferrer">
                <img className='w-12 h-12 hover:w-16 hover:h-16' src='https://img.icons8.com/doodle/40/000000/linkedin--v2.png' />
              </a>
