...
'/>
        ...
        <div className='projects text-2xl flex flex-col space-y-4 my-10'>
          ...
          <div className='pl-24'>
            description: "A social web app like Dev.to. Here you can create articles, like or comment on articles, or save articles for later read. Firstly you need to create an account / login then you could use all the features provided.",
          </div>
          <div className='pl-24'>
            completedIn: "1.5 months",
          </div>
          ...
          <div className='pl-24'>
            site: <a href='https://mujirushi.netlify.app/' target="_blank" rel="noopener noreferrer">https://mujirushi.netlify.app</a>
          </div>
          <div className='pl-16'>
            &#125;,
          </div>
