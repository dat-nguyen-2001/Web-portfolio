  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home flex flex-col-reverse md:flex-row w-screen pt-20 sm:pt-12 md:pt-24'>
          ...
          <div className='w-[60vw] max-w-[250px] sm:w-[40vw] sm:max-w-[350px] h-auto mx-auto'>
