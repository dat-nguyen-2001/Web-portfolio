          ...
          <div className='introduction flex flex-col space-y-3 sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[900] h-[120px] ml-[8vw] mt-[35vh] md:mt-[30vh] w-auto'>
            ...
            <div className='flex space-x-10 py-5'>
              ...
              <a href='https://stackoverflow.com/users/19545617/dat-nguyen' target="_blank" rel="noopener noreferrer">
                <img className='mediaIcon w-8 md:h-8 lg:w-10 lg:h-10' src='https://img.icons8.com/external-tal-revivo-color-tal-revivo/40/000000/external-stack-overflow-is-a-question-and-answer-site-for-professional-logo-color-tal-revivo.png' />
              </a>
            </div>
