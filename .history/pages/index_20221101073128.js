    ...
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        ...
        <div className='home h-[35%]'>
          <div className='introduction flex flex-col space-y-3 sm:text-[1.7rem]  md:text-[2.1rem] lg:text-[2.7rem] font-[900] h-[120px] ml-[8vw] mt-[35vh] md:mt-[30vh] w-auto'>
        ...
        <div className='projects lg:text-[1.2rem] xl:text-[1.3rem] flex flex-col space-y-4 my-10'>
          ...
          <div className='flex'>
            ...
            <div className='flex pl-24 flex-wrap'>
              ...
              <img className='h-7 w-auto ml-4' src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' />
              <img className='h-6 w-auto ml-4' src='https://img.shields.io/badge/tailwindcss-%2338B2AC.svg?style=for-the-badge&logo=tailwind-css&logoColor=white' />
