  ...
  return (
    <div>
      ...
      <main className='overflow-x-hidden h-screen'>
        <div className='z-50 fixed top-0 w-screen h-[60px] bg-gradient-to-t from-gray-700 to-gray-800 flex space-between items-center px-10 nav'>
      ...
      <div className='px-28 mt-10'>
        <div className='about text-[1.3rem] flex flex-col space-y-4 mb-10'>
          ...
          <h1 className='text-3xl'><span className='lineNumber'>2 </span> &lt;/<span className='text-red-700'>about</span>&gt;</h1>
        </div>

        <hr></hr>

        <div className='skills text-[1.3rem] flex flex-col space-y-4 my-10'>
          <h1 className='text-3xl'><span className='lineNumber'>2 </span>&lt;<span className='text-red-700'>skills</span>&gt;</h1>
          <div><span className='lineNumber'>2 </span><span className='text-[#f9db9b]'>Console</span>.<span className='text-[#1cbae8]'>log</span><span className='text-[#bd7b4c]'>( </span><span className='text-[#f9db9b]'>Dat</span>.<span className='text-red-500'>skills</span><span className='text-[#bd7b4c]'> )</span>;</div>
          <div className='flex'>
            <span className='lineNumber'>2 </span>
        ...
        <div className='projects text-[1.3rem] flex flex-col space-y-4 my-10'>
          <h1 className='text-3xl'><span className='lineNumber'>2 </span>&lt;<span className='text-red-700'>projects</span>&gt;</h1>
          <div><span className='lineNumber'>2 </span><span className='text-[#f9db9b]'>Console</span>.<span className='text-[#1cbae8]'>log</span><span className='text-[#bd7b4c]'>( </span><span className='text-[#f9db9b]'>Dat</span>.<span className='text-red-500'>projects</span><span className='text-[#bd7b4c]'> )</span>;</div>
          <div className='flex'>
            <span className='lineNumber'>2 </span>
            <div className='pl-8'><span className='text-[#bd7b4c]'>[</span></div>
          </div>
          ...
          <div><span className='lineNumber'>2 </span></div>
          ...
          <div className='flex'>
            ...
            <div className='pl-24'>
              <span className='text-red-500'>id </span>
              :
              <span className='text-[#bd7b4c]'> 2 </span>,
            </div>
          </div>
          <div className='flex'>
            <span className='lineNumber'>2 </span>
          ...
          <div></div>
          <div className='pl-8'><span className='text-[#bd7b4c]'>]</span></div>
          <h1 className='text-4xl'>&lt;/<span className='text-red-700'>projects</span>&gt;</h1>
        </div>
